...
根据同一篇中文小说文本的外部实测，朱雀为人工100%，Qwen3.5 4B 本地人工74.27%，MiniCPM3 4B 本地人工5.42%。生产中文统计检测基座因此切换为 Qwen3.5 4B，MiniCPM3 4B 从模型注册表移除。下方 Qwen3.5 0.8B 结果保留为历史实验记录，不代表当前生产默认模型。
