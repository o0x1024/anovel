...
export const STEP_MODEL_GROUPS: StepModelGroupDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { step: 'story_engine_semantic_audit', label: '短故事发动机窄问题审计' },
      { step: 'story_contract_gate', label: '短故事全篇合同' },
      { step: 'story_continuity_gate', label: '短故事跨拍连续性' },
      { step: 'story_continuity_repair', label: '短故事连续性修复' },
      ...
      { step: 'story_title_hook_gate', label: '短故事导语防剧透' },
